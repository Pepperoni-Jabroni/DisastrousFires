...
import pepjebs.disastrousfires.config.DisastrousFiresConfig;
import pepjebs.disastrousfires.entity.ExtinguisherFoamEntity;

import java.util.List;

public class DisastrousFiresMod implements ModInitializer {

    public static final String MOD_ID = "disastrous_fires";
    public static final DisastrousFiresConfig CONFIG =
            AutoConfig.register(DisastrousFiresConfig.class, JanksonConfigSerializer::new).getConfig();
                ...
                new Block(FabricBlockSettings.create().ticksRandomly().sounds(BlockSoundGroup.GRASS).hardness(0.6F)) {
                    ...
                    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
                        ...
                        if (random.nextInt(decomposeBound) == 0) {
                            ...
                            if (aboveId == DisastrousFiresMod.BURNED_GRASS_ID ||
                                    aboveId == DisastrousFiresMod.BURNED_FLOWER_ID) {
